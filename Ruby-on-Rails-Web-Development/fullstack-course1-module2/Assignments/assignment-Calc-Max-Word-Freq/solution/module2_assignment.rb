...
class Solution
  ...
  def calculate_line_with_highest_frequency
    @highest_count_across_lines = @analyzers.sort_by { |a| a.highest_wf_count }.last.highest_wf_count
  ...
  def print_highest_word_frequency_across_lines
    ...
    @highest_count_words_across_lines.each { |a| puts "#{a.highest_wf_words} (appears in line #{a.line_number})" }
  end
end
